...
## Play the Game
You can play Am I Edible? at [amiedible.com](http://amiedible.com).

## "Fun"ctional Example App
Am I Edible? is three screen interface that demonstrates core Ruby on Rails concepts in a compact application. Check out the live version at [amiedible.com](http://amiedible.com). Then, fork this repo and follow the instructions below to get it working on your local machine so you can start exploring the code.
